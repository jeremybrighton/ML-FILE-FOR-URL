...
uri = "mongodb+srv://FraudAdmin:Jeremy5195@detect.vn1wne0.mongodb.net/?appName=detect&tls=true"
...
client = MongoClient(
    ...
    tlsAllowInvalidCertificates=False,  # ensure proper cert validation
    tlsCAFile=None,                     # use default CA
# Collections
